...
for cnt in contour:
    ...
    if len(approx) == 3:
        cv2.putText(img,'Triangle',(x,y),cv2.FONT_HERSHEY_DUPLEX,1,(0,0,0))
    elif len(approx) == 4:
        cv2.putText(img,'Drepnughi',(x,y),cv2.FONT_HERSHEY_DUPLEX,1,(0,0,0))
    elif len(approx) == 5:
        cv2.putText(img,'Pentagon',(x,y),cv2.FONT_HERSHEY_SCRIPT_COMPLEX,1,(0,0,0))
    elif 6 < len(approx) <15:
        cv2.putText(img,'Eclipse',(x,y),cv2.FONT_HERSHEY_SCRIPT_COMPLEX,1,(0,0,0))
    else:
        cv2.putText(img,'Cerc',(x,y),cv2.FONT_HERSHEY_SCRIPT_COMPLEX,1,(0,0,0))
